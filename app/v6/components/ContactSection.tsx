...
function CalEmbed() {
  ...
  useEffect(() => {
    ...
    Cal('inline', {
      elementOrSelector: '#cal-embed-v6',
    ...
    const checkLoaded = setInterval(() => {
      const el = document.getElementById('cal-embed-v6')
  ...
  return (
    <>
      {!loaded && !timedOut && (
        <div className="v2-cal-skeleton">
          <div className="v2-cal-skeleton-spinner" />
          <p>Loading calendar...</p>
        </div>
      )}
      {timedOut && !loaded && (
        <div className="v2-cal-skeleton" style={{ minHeight: 200 }}>
          <p style={{ fontSize: '1rem', color: 'var(--v2-text-muted)', textAlign: 'center', maxWidth: 360 }}>
            Calendar taking a while to load?{' '}
            <a href="https://cal.com/niceright/30min" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--v2-accent)', fontWeight: 600 }}>
              Book directly on Cal.com
            </a>{' '}
            or{' '}
            <a href="mailto:Marcin@uxoxo.xyz" style={{ color: 'var(--v2-accent)', fontWeight: 600 }}>
              email me
            </a>.
          </p>
        </div>
    ...
    <section id="contact" className="v2-contact">
      <div className="v2-container">
        <div className="v2-contact-inner">
          ...
          <p style={{ fontSize: '0.95rem', color: 'var(--v2-text-dim)', marginTop: 48, marginBottom: 24 }}>
            Prefer to reach out directly?
          </p>

          <div className="v2-contact-methods" style={{ marginBottom: 0 }}>
