  ...
  return (
    <section ref={sectionRef} id="results" className="v2-results">
      <div className="v2-container">
        ...
        {/* About -- elevated as standalone block */}
        <div className="v2-about-card v2-reveal v2-reveal-delay-4" style={{ marginTop: 64 }}>
          <img
            src="/images/hero-abstract.svg"
            alt="Nice Right"
          />
          <div>
            <p style={{ fontSize: '1.05rem', color: 'var(--v2-text)', lineHeight: 1.7, margin: 0 }}>
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--v2-text-dim)', marginTop: 8, marginBottom: 0 }}>
