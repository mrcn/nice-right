...
export default function SkinInGameLanding() {
    ...
    <div className="min-h-screen bg-[#0a0f0d] text-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center hero-content">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#0B8A6E]/10 border border-[#06D6A0]/20 rounded-full mb-8">
            ...
            <span className="text-[#06D6A0] text-sm font-medium">Only 1 Client Per Quarter</span>
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif leading-tight mb-6">
            I Will Rebuild Your <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">Website</span> <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">For</span> $1,000 Upfront
          </h1>

          <p className="text-xl text-gray-400 mb-4">You Pay The Other $9,000 Only If I Generate $50,000 In Tracked Revenue Within 90 Days</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Burned by Agencies</h3>
              <p className="text-gray-400">Paid $20K+ for websites that look pretty but generate zero revenue.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Paid Upfront No Results</h3>
              <p className="text-gray-400">Agencies get paid whether you win or lose. No skin in the game.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Wasted Budget</h3>
              <p className="text-gray-400">Months of delays, excuses, and finally — a website that sits there doing nothing.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0B8A6E]/10 to-transparent section-reveal">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-serif mb-6">
            $50,000 Revenue Guaranteed <span className="text-[#06D6A0]">Or Keep Everything For $1,000</span>
          </h2>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 section-reveal">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto p-8 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl border border-gray-700 text-center">
            ...
            <div className="text-xl text-gray-400 mb-8">+ $9,000 only after $50K revenue</div>
      ...
      <section id="apply" className="py-24 px-4 sm:px-6 lg:px-8 section-reveal">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            href="mailto:hello@niceright.co?subject=skin-in-game Application"
