...
export default function TableturnDirectLanding() {
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center hero-content">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#0B8A6E]/10 border border-[#06D6A0]/20 rounded-full mb-8">
            ...
            <span className="text-[#06D6A0] text-sm font-medium">Limited Availability Per Metro Area</span>
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif leading-tight mb-6">
            Cut Delivery App <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">Fees</span> <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">by</span> 80%
          </h1>

          <p className="text-xl text-gray-400 mb-4">Transfer Your Customers From DoorDash Into YOUR Database</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">25-30% Delivery Fees</h3>
              <p className="text-gray-400">You are paying a quarter of your revenue to apps just for the privilege of existing.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">No Customer Data</h3>
              <p className="text-gray-400">DoorDash owns your customer relationships. You cannot market to them, they are not yours.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Platform Dependency</h3>
              <p className="text-gray-400">One algorithm change and your revenue drops 50%. You are building on rented land.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0B8A6E]/10 to-transparent section-reveal">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-serif mb-6">
            $25,000 in Direct Orders <span className="text-[#06D6A0]">Or We Pay YOU $5,000</span>
          </h2>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 section-reveal">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto p-8 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl border border-gray-700 text-center">
            ...
            <div className="text-xl text-gray-400 mb-8">+ $950/month</div>
      ...
      <section id="apply" className="py-24 px-4 sm:px-6 lg:px-8 section-reveal">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            href="mailto:hello@niceright.co?subject=tableturn-direct Application"
