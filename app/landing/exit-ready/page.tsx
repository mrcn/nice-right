...
export default function ExitReadyLanding() {
    ...
    <div className="min-h-screen bg-[#0C1117] text-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center hero-content">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#0B8A6E]/10 border border-[#06D6A0]/20 rounded-full mb-8">
            ...
            <span className="text-[#06D6A0] text-sm font-medium">Only 2 Clients Per Year — 2025 Waitlist Open</span>
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif leading-tight mb-6">
            Add $250K-$1M+ to <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">Your</span> <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">Business</span> Sale Price
          </h1>

          <p className="text-xl text-gray-400 mb-4">By Making Your Company Irresistible to Buyers</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Owner-Dependent</h3>
              <p className="text-gray-400">Buyers see a business that cannot run without you. This destroys valuation and limits buyer pool.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">No Systems Documentation</h3>
              <p className="text-gray-400">Everything is in your head. No processes, no playbooks, no institutional knowledge.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Declining Sale Multiple</h3>
              <p className="text-gray-400">Without exit preparation, you will get 2-3x earnings. With preparation, you get 5-7x.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0B8A6E]/10 to-transparent section-reveal">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-serif mb-6">
            15% Valuation Increase <span className="text-[#06D6A0]">Or Full Refund</span>
          </h2>
        </div>
      </section>
      ...
      <section id="apply" className="py-24 px-4 sm:px-6 lg:px-8 section-reveal">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            href="mailto:hello@niceright.co?subject=exit-ready Application"
