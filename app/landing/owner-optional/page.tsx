...
export default function OwnerOptionalLanding() {
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center hero-content">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif leading-tight mb-6">
            Go from Working IN <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">Your</span> <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">Business</span> to Owning It
          </h1>

          <p className="text-xl text-gray-400 mb-4">In 90 Days or I Work Free Until You Do</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Can Never Leave</h3>
              <p className="text-gray-400">Vacations mean constant calls. The business stops when you stop. You are trapped.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Everything Depends on You</h3>
              <p className="text-gray-400">Decisions, problems, approvals — all flow through you. No delegation, no freedom.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Burnout</h3>
              <p className="text-gray-400">Years of 70-hour weeks. The passion is gone but you cannot step away.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0B8A6E]/10 to-transparent section-reveal">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-serif mb-6">
            Operationally Optional in 90 Days <span className="text-[#06D6A0]">Or Work Free Until Achieved</span>
          </h2>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 section-reveal">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto p-8 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl border border-gray-700 text-center">
            ...
            <div className="text-xl text-gray-400 mb-8">Flat fee</div>
      ...
      <section id="apply" className="py-24 px-4 sm:px-6 lg:px-8 section-reveal">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            href="mailto:hello@niceright.co?subject=owner-optional Application"
