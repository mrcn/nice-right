...
export default function InvisibleCooLanding() {
    ...
    <div className="min-h-screen bg-[#08090c] text-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center hero-content">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#0B8A6E]/10 border border-[#06D6A0]/20 rounded-full mb-8">
            ...
            <span className="text-[#06D6A0] text-sm font-medium">Only 4 Partnerships Maximum</span>
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif leading-tight mb-6">
            For $30,000, I Become Your <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">Chief</span> <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">Digital</span> Officer For 12 Months
          </h1>

          <p className="text-xl text-gray-400 mb-4">You Get Enterprise-Level Strategy Without The Enterprise Headcount</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              ...
              <p className="text-gray-400">Tactical work without direction. Posting on social, running ads, no cohesive plan.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Execution Bottleneck</h3>
              <p className="text-gray-400">Ideas pile up, nothing gets done. You need implementation, not more advice.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">$120K+ for In-House Team</h3>
              <p className="text-gray-400">Hiring a CMO, designers, developers — out of reach for most businesses.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0B8A6E]/10 to-transparent section-reveal">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-serif mb-6">
            First 30 Days Free If No Results <span className="text-[#06D6A0]">Or Full Refund</span>
          </h2>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 section-reveal">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto p-8 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl border border-gray-700 text-center">
            ...
            <div className="text-xl text-gray-400 mb-8">per year</div>
      ...
      <section id="apply" className="py-24 px-4 sm:px-6 lg:px-8 section-reveal">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            href="mailto:hello@niceright.co?subject=invisible-coo Application"
