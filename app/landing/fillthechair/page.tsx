...
export default function FillthechairLanding() {
    ...
    <div className="min-h-screen bg-[#0a0f0d] text-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center hero-content">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#0B8A6E]/10 border border-[#06D6A0]/20 rounded-full mb-8">
            ...
            <span className="text-[#06D6A0] text-sm font-medium">8 Practices Per Specialty Per Metro</span>
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif leading-tight mb-6">
            Eliminate No-Shows. Fill Your <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">Schedule</span> <span className="bg-gradient-to-r from-[#0B8A6E] to-[#06D6A0] bg-clip-text text-transparent">With</span> Cash-Pay Patients
          </h1>

          <p className="text-xl text-gray-400 mb-4">Without Your Staff Lifting a Finger</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">No-Shows Costing $150K+/Year</h3>
              <p className="text-gray-400">Empty chairs are bleeding money. Insurance reimbursements do not cover the loss.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Empty Chairs</h3>
              <p className="text-gray-400">Your schedule looks full but 15% of patients ghost you. No backup plan, no waitlist.</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <h3 className="text-xl font-semibold mb-3">Insurance Dependency</h3>
              <p className="text-gray-400">Payers control your pricing. You are working harder for less margin every year.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0B8A6E]/10 to-transparent section-reveal">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-serif mb-6">
            Under 6% No-Show Rate <span className="text-[#06D6A0]">Or Full Refund + $500</span>
          </h2>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 section-reveal">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto p-8 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl border border-gray-700 text-center">
            ...
            <div className="text-xl text-gray-400 mb-8">+ $850/month</div>
      ...
      <section id="apply" className="py-24 px-4 sm:px-6 lg:px-8 section-reveal">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            href="mailto:hello@niceright.co?subject=fillthechair Application"
