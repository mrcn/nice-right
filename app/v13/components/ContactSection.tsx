...
function CalEmbed() {
  ...
  useEffect(() => {
    ...
    Cal('inline', {
      elementOrSelector: '#cal-embed-v13',
    ...
    Cal('ui', {
      ...
      cssVarsPerTheme: {
        light: {
          'cal-brand': '#7B61FF',
          'cal-text': '#F0ECF8',
          'cal-text-emphasis': '#F0ECF8',
          'cal-border-emphasis': 'rgba(255,255,255,0.1)',
          'cal-bg': '#0F0B1E',
          'cal-bg-emphasis': '#1A1040',
        },
      },
    })

    const checkLoaded = setInterval(() => {
      const el = document.getElementById('cal-embed-v13')
  ...
  return (
    <>
      {!loaded && !timedOut && (
        <div className="v13-cal-skeleton">
          <div className="v13-cal-spinner" />
          <p>Loading calendar...</p>
        </div>
      )}
      {timedOut && !loaded && (
        <div className="v13-cal-skeleton" style={{ minHeight: 200 }}>
          <p className="v13-cal-fallback">
...
export function ContactSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.fromTo(
        el.querySelector('.v13-contact-inner'),
        { opacity: 0, y: 40 },
        {
          opacity: 1,
          y: 0,
  ...
  return (
    <section ref={sectionRef} id="contact" className="v13-contact">
      <div className="v13-container">
        <div className="v13-contact-inner v13-glass-card">
          <h2>Let&apos;s figure out what would work for your business</h2>
          <p className="v13-contact-sub">
            30 minutes. Pick a time that works for you.
          </p>

          <div className="v13-cal-container">
            <CalEmbed />
          </div>

          <p className="v13-contact-alt-label">Prefer to reach out directly?</p>

          <div className="v13-contact-methods">
            <a href="mailto:Marcin@uxoxo.xyz" className="v13-contact-card v13-glass-card">
              <div className="v13-contact-icon">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="v13-contact-card v13-glass-card"
            >
              <div className="v13-contact-icon">
