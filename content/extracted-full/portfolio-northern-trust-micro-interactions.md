# **Designing & Developing Mirco-Interactions for Northern Trust’s Corporate Website**

### **Project Overview**

As a contracted UX designer and developer, I was engaged to enhance a Northern Trust’s global online presence through strategic addition of micro-interactions and transitions.

The initial 6-week project aimed to implement a carefully curated set of animations on the client’s public website, with the goal of elevating the brand experience and improving user engagement.

### **Role and Collaboration**

While working primarily independently, I maintained close collaboration with key stakeholders within the organization: Front-End Engineer, Senior UX Designer, UX Manager

This collaborative approach ensured solid integration of my work into the client’s development environment and brand guidelines.

### **Project Scope and Evolution**

The initial engagement focused on:

1. Designing and prototyping brand-centric animations
2. Coding and implementing these elements into the live website
3. Measuring success through brand cohesion and feel.
...
By incorporating these brand-centric elements, we achieved a dual-purpose solution:

1. Engaging user attention with key elements
2. Reinforcing the brand narrative throughout the user journey
...
Before diving into the process, let’s look at some of the results and the reasoning behind them.

### **Hero Load Sequence**

The hero section animation activates upon page load, featuring an interactive line progressively drawn across the page, sequential fade-in of nearby elements, cued by the line animation’s left-to-right motion, gradient exposure, and progressive fade-ins. This required custom motion eases crafted specifically for this demo

The sequence concludes by highlighting tiles on the right side of the screen, subtly directing viewer attention.

### **Revealing Page Elements During Scroll**
...
### **Animated Interactive Vue Component**

I created a prototype for a tab-change animation coded with Vue.js and GSAP based on designs provided by the client. I split the hexagonal image split into several layers, each containing an individual hexagon. The transitional animations are triggered by clicking the tabs.
...
### **Project Preparation and Research**
...
Given the client’s busy schedule, we adopted a direct approach:

1. Developed initial variations
2. Narrowed down options
3. Presented to stakeholders for feedback
4. Refined based on input
5. Final presentation to the Director of Marketing
...
The exercise focused on two key questions:

1. Which elements, when animated, would potentially have the most significant impact on user experience?
2. Considering the client’s technical architecture, how challenging would each element be to implement?
#### **Methodology**
...
![](https://uxoxo.xyz/wp-content/uploads/2024/07/impact-return-matrix-for-design.webp)![](https://uxoxo.xyz/wp-content/uploads/2024/07/impact-return-matrix-for-design.webp)
...
This exercise resulted in a clear, prioritized list of animation elements to focus on. It helped us:

- Identify high-impact, lower-effort quick wins
- Recognize potentially challenging implementations that might require additional resources or reconsideration
- Align the team on priorities and expectations for the animation phase of the project
...
### **Additional Finalized Animations**

#### **Headers**

The header image is large, and therefore needs to move more slowly than smaller elements to achieve the same effect.



## Videos

- **YouTube:** https://www.youtube.com/embed/gbGHvEiZT7Y?feature=oembed
- **YouTube:** https://www.youtube.com/embed/7IIi7cutMzY?feature=oembed
- **YouTube:** https://www.youtube.com/embed/v432vRNkRbY?feature=oembed
- **YouTube:** https://www.youtube.com/embed/NWuMI7CY1Cc?feature=oembed
- **YouTube:** https://www.youtube.com/embed/DKmFuTVYvj4?feature=oembed
- **YouTube:** https://www.youtube.com/embed/fcjiQzf_GVM?feature=oembed
- **YouTube:** https://www.youtube.com/embed/ztjUp1OetQI?feature=oembed
- **YouTube:** https://www.youtube.com/embed/z9GDUW84NrA?feature=oembed
- **YouTube:** https://www.youtube.com/embed/ahSfTIIveBI?feature=oembed
- **YouTube:** https://www.youtube.com/embed/kjYDEI3vRLA?feature=oembed
- **YouTube:** https://www.youtube.com/embed/w3mZ-qDJW6o?feature=oembed